...
The easiest way to get started is by copying the example file from [Mini-Lesson: Inserting new Elements within a Page](https://gitlab.com/kenzie-academy/se/fe/getting-started-with-javascript/m_insert-elements). You can copy and paste from the code embedded in the lesson.
